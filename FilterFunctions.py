...
def DeclareVariables2(df, title, save=True):
    finalVariables2 = {'mu_pt','el_pt','mu_eta','el_eta','mu_phi','el_phi','mu_mass',
                       'el_mass','mu_q','el_q','inv_m','MET_pt','MET_phi','eventWeightLumi'}
...
def DeclareVariables4(df, title, save=True):
    finalVariables4 = {'lep_pt0','lep_pt1','lep_pt2','lep_eta0','lep_eta1','lep_eta2',
                       'lep_phi0','lep_phi1','lep_phi2','lep_mass0','lep_mass1','lep_mass2',
                       'lep_q0','lep_q1','lep_q2','inv_m01','inv_m12','inv_m02','inv_m3',
                       'dR01','dR02','MET_pt','MET_phi','eventWeightLumi'}
    ...
    if save:
        define.Snapshot('Events', dirOutPath + title + 'Flat4.root', finalVariables4)
